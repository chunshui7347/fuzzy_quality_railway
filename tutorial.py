...
# plt.plot(cleanness,dirty,cleanness,normal,cleanness,clean)
# plt.plot(price,cheap,price,reasonable,price,expensive)
# plt.plot(frequency,less,frequency,enough,frequency,many)
# plt.plot(quality,low,quality,medium,quality,high)
# plt.show()
